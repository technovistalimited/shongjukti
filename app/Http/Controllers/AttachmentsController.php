...
class AttachmentsController extends Controller
{
     ...
     * --------------------------------------------------------------------------
     */
    public static $uploadMaxSize = 5000000; // 5mb in bytes
     ...
     * --------------------------------------------------------------------------
     */
    public static $defaultExtensions = 'jpg, gif, png, pdf';
     ...
     * --------------------------------------------------------------------------
     */
    public static function mimeTypes($fileExtension)
    {
        //default
        $mime = $fileExtension;
    ...
    public static function mimeTypesFromExtensions($fileExtensions)
    {
        ...
        foreach ($fileTypes as $fileExtension) {
            ...
            // Get MIME TYPE
            $mimeTypes[$fileExtension] = self::mimeTypes($fileExtension);
        }
     ...
     * --------------------------------------------------------------------------
     */
    public function attachmentTypesIndex( $scopeKey = '' ) {
     ...
     * --------------------------------------------------------------------------
     */
    public function attachmentTypesAdd() {
        $attachmentScopes = self::attachmentScopes();

        return view('settings.attachment-types.add', compact('attachmentScopes'));
    }
     ...
     * --------------------------------------------------------------------------
     */
    public function attachmentTypesStore(Request $request)
    {
        try
        {
            $inputs = $request->all();
            ...
            if ($validator->fails()) {
                ...
                $editPageUrl = action('AttachmentController@attachmentTypesEdit', ['attachmentTypeId' => $attachmentType->id]);
     ...
     *
     * @param  integer $attachmentTypeId Attachment Type ID.
     *
     * @return \Illuminate\Http\Response
     * --------------------------------------------------------------------------
     */
     ...
     * --------------------------------------------------------------------------
     */
    public function attachmentTypesUpdate(Request $request) {
        try {
            $inputs = $request->all();
